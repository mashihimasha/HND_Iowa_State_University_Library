...
<html>
 ...
 <div class="content">
	<!-- Navigation -->
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" style="position:relative;top:-35px;padding-top:35px;" id="mainNav">
	  <div class="container">
	...
	<header class="pb-3 mb-3">
		<div class="container input-group">
			<form class="form-inline form-control-lg my-2 my-lg-0" action="searchAdmin.php" method="GET">
