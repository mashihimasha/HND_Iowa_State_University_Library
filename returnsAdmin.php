	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
	  <div class="container">
		...
		<header>
			...
			<h3 class="display-4 pt-5 text-center">Book Return Details</h3>
			</div>
		</header>

<?php	
	$pdo_statement = $pdo_conn->prepare("SELECT * FROM return_details ORDER BY ReturnID DESC");
...
?>
	...
	<div class="container py-3 my-3" >
							...
							<div class="dropdown dropright">
								...
								<i class="fas fa-sort"></i>  Sort by
								  ...
								  <div class="dropdown-menu">
									<a class="dropdown-item" href="#" onclick="sortTable(0)"> <i class="fas fa-sort-numeric-up"></i>  Return ID</a>
									<a class="dropdown-item" href="#" onclick="sortTable(4)"> <i class="fas fa-sort-numeric-up"></i>  Member ID</a>
									<a class="dropdown-item" href="#" onclick="sortTable(3)"> <i class="fas fa-sort-numeric-up"></i>  Book ID</a>
									<a class="dropdown-item" href="#" onclick="sortTable2(1)"><i class="fas fa-calendar-check"></i>  Return Date</a>
								  </div>
							</div>
						</li>
						<li class="nav-item p-2">
		...
		<div class="adminForm modal fade" role="dialog" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" id="myModal">
				...
				<div style="margin:20px 0;text-align:right;"><a href="returnsAdmin.php" class="btn btn-orange round text-light">Back to List</a></div>
					<form name="editForm" action="add.php" method="POST">
					  <div class="form-group row">
						...
						<input type="text" class="form-control" id="id" name="id" placeholder="Enter return ID" required>
					  </div>
					  <div class="form-group row">
					  ...
					  <div class="form-group row">
						<button type="submit" name="save1" value="Save" class="btn btn-success round btn-block">Save</button>
					  </div>
					</form>
				</div> 
			</div>
		  ...
		  <tbody id="table-body">
			...
			?>
			  <tr class="tbl-row">
				...
				<a class="ajax-action-links" href='edit.php?id1=<?php echo $row['ReturnID']; ?>'>
				<i class="far fa-edit btn btn-success round text-light" title="Edit"></i></a> 
				<a class="ajax-action-links" href="javascript:delete_data(<?php echo $row['ReturnID']; ?>)">
