  ...
  <div class="content">
	...
	<header class="pt-3 mt-3">
		<div class="header-image" style="background-image: url('assets/img/book1.jpg')">
			<div>
			  <h1 class="heading display-4 pt-3 mt-3 text-center">Returned Books</h1>
			</div>
		</div>
	</header>
	<div class="container mt-3 pt-3">
	  <div class="row">
		...
		<?php
			...
			$total_pages_sql="select count(*) From return_details,Book_Details WHERE return_details.MemberID='$mid' AND return_details.BookID=Book_Details.BookID";
			$result = mysqli_query($conn,$total_pages_sql);
			$total_rows=mysqli_fetch_array($result)[0];
			$total_pages=ceil($total_rows/$no_of_records_per_page);

			$sql="select * from return_details,Book_Details WHERE return_details.MemberID='$mid' AND return_details.BookID=Book_Details.BookID LIMIT $offset,$no_of_records_per_page";
			...
			<div style="text-align:right;">
				<div style="display:inline-block">
					<ul class="pagination">
						...
						<li class="btn btn-orange" class="<?php
