	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
	  <div class="container">
		...
		<header>
			...
			<h3 class="display-4 pt-5 text-center">Available Books</h3>
			</div>
		</header>
	<?php	
		$pdo_statement = $pdo_conn->prepare("SELECT * FROM book_details WHERE BookStatus='Available' ORDER BY BookID DESC");
