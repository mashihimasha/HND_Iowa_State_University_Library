	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
	  <div class="container">
		...
		<header>
			...
			<h3 class="display-4 pt-5 text-center">Member Details</h3>
			</div>
		</header>

<?php	
	$pdo_statement = $pdo_conn->prepare("SELECT * FROM member_details ORDER BY MemberID DESC");
							...
							<div class="dropdown dropright">
								...
								<i class="fas fa-sort"></i>  Sort by
								  ...
								  <div class="dropdown-menu">
									<a class="dropdown-item" href="#" onclick="sortTable(0)"> <i class="fas fa-sort-numeric-up"></i>  Member ID</a>
									<a class="dropdown-item" href="#" onclick="sortTable1(1)"><i class="fas fa-sort-alpha-down"></i>  Name</a>
								  </div>
							</div>
						</li>
				  </ul>
