	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
	  <div class="container">
		...
		<header>
			...
			<h3 class="display-4 pt-5 text-center">Book Lending Details</h3>
			</div>
		</header>
	<?php	
		$pdo_statement = $pdo_conn->prepare("SELECT * FROM Borrow_Details ORDER BY BorrowID DESC");
								...
								<div class="dropdown dropright">
									...
									<i class="fas fa-sort"></i>  Sort by
									  ...
									  <div class="dropdown-menu">
										<a class="dropdown-item" href="#" onclick="sortTable(0)"> 
											<i class="fas fa-sort-numeric-up"></i>  
											Borrow ID
										</a>
										<a class="dropdown-item" href="#" onclick="sortTable(4)"> 
											<i class="fas fa-sort-numeric-up"></i>  
											Member ID
										</a>
										<a class="dropdown-item" href="#" onclick="sortTable2(1)">
		  ...
		  <tbody id="table-body">
			...
			?>
			  <tr id="tbl-row">
				...
				<a class="ajax-action-links" href='edit.php?id=<?php echo $row['BorrowID']; ?>'>
					<i class="far fa-edit btn btn-success round text-light" title="Edit" style="color:white"></i></a> 
				<a class="ajax-action-links" href="javascript:delete_data(<?php echo $row['BorrowID']; ?>)">
					<i class="fas fa-trash btn btn-success round text-light" title="Delete" style="color:white"></i></a>
				</td>
			  </tr>
			<?php
				}
				  ...
				  <div class="container-fluid p-5 border border-dark rounded table-dark">
					...
					<form name="editForm" action="add.php" method="POST">
					  <div class="form-group row">
						...
						<input type="text" class="form-control" id="id" name="id" placeholder="Enter borrow ID" required>
					  </div>
					  <div class="form-group row">
						<div class="col">
